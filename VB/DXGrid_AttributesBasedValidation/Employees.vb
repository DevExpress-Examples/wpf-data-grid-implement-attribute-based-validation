...
Public Module Stuff
    ...
    Public Function GetStuff() As List(Of Employee)
        ...
        stuff.Add(New Employee() With {.ID = 2, .ParentID = 1, .Name = String.Empty, .Department = "Marketing", .Position = "Vice President"})
        ...
        stuff.Add(New Employee() With {.ID = 5, .ParentID = 1, .Name = String.Empty, .Department = "Finance", .Position = "Vice President"})
        ...
        stuff.Add(New Employee() With {.ID = 8, .ParentID = 2, .Name = "", .Department = "Marketing", .Position = "Manager"})
        stuff.Add(New Employee() With {.ID = 9, .ParentID = 2, .Name = "", .Department = "Marketing", .Position = "Manager"})
